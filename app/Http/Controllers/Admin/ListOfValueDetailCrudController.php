...
use App\Http\Requests\ListOfValueDetailRequest as StoreRequest;
use App\Http\Requests\ListOfValueDetailRequest as UpdateRequest;

class ListOfValueDetailCrudController extends CrudController
{
    public function setup() {
        ...
        */
        ...
        $this->crud->addButtonFromView('top', 'list_of_value_top', 'list_of_value_top', 'beginning');
    }

    public function store(StoreRequest $request, $parent_id = '') {
