                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="profile-section margin-bottom-20">
                            {!! Form::model($user, ['url' => 'profile/settings/updateUser', 'method' => 'post', 'files' => true]) !!}
                            <div class="row">
                        ...
                        <div class="profile-section margin-bottom-20">
                            {!! Form::model($profile, ['url' => 'profile/settings', 'method' => 'post', 'files' => true]) !!}
                            <div class="row">
                                <div class="form-group col-md-12 {{ $errors->has('avatar') ? ' has-error' : '' }}">
                                    {!! Form::label('avatar', __('profile.avatar')) !!}<br>
                                    <img id="imgAvatar"
                                ...
                                {{--{!! Form::select('city_id', \App\Models\Zone::all()->pluck('name', 'id'), null, ['class' => 'form-control']) !!}--}}
                                {{--@if ($errors->has('mobile_no'))--}}
                                {{--<span class="text-danger">{{ $errors->first('mobile_no') }}</span>--}}
                                {{--@endif--}}
                                {{--</div>--}}
                                <div class="form-group col-md-12 {{ $errors->has('location') ? ' has-error' : '' }}">
                                    {!! Form::label('location', __('profile.location')) !!}
