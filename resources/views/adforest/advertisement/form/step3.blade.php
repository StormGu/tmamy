                ...
                <div class="ad-box">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group @if ($errors->has('title')) has-error @endif">
                            {!! Form::text('title', null, ['placeholder' => __('advertisement.title'), 'class' => 'form-control margin-top-10']) !!}
                            @if ($errors->has('title'))
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group @if ($errors->has('price')) has-error @endif">
                                    {!! Form::text('price', null, ['placeholder' => __('advertisement.price'), 'class' => 'form-control margin-top-10']) !!}
                                    @if ($errors->has('price'))
                            ...
                            <div class="col-md-5">
                                <div class="form-group @if ($errors->has('currency_id')) has-error @endif">
                                    {!! Form::select('currency_id', \App\Models\Constant::where('key', '=', 'currency')->pluck('value', 'id'), null, ['placeholder' => __('advertisement.currency_id'), 'class' => 'form-control margin-top-10 required']) !!}
                        ...
                        <div class="form-group @if ($errors->has('mobile')) has-error @endif">
                            {!! Form::text('mobile', null, ['placeholder' => __('advertisement.mobile'), 'class' => 'form-control margin-top-10']) !!}
                            @if ($errors->has('mobile'))
                                <span class="text-danger">{{ $errors->first('mobile') }}</span>
                            @endif
                        </div>
                        <div class="form-group @if ($errors->has('phone')) has-error @endif">
                            {!! Form::text('phone', null, ['placeholder' => __('advertisement.phone'), 'class' => 'form-control margin-top-10']) !!}
                            @if ($errors->has('phone'))
                                <span class="text-danger">{{ $errors->first('phone') }}</span>
                            @endif
                        </div>
                        <div class="form-group @if ($errors->has('details')) has-error @endif">
                            {!! Form::textarea('details', null, ['placeholder' => __('advertisement.details'), 'class' => 'form-control margin-top-10']) !!}
